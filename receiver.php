...
function validate1()
	 {
		 ...
		 if (document.getElementById("unit").value == "")
		 {
		  ...
		  if (document.getElementById("hospital-address").value == "")
		 {
			 alert("Please enter Hospital Address");
			 document.getElementById("hospital-address").focus();
			 return false;
		 }
		...
		//pincode
		 ...
		 //doctor-name
		  if (document.getElementById("whenreq").value == "")
		 {
			 alert("Select Date");
			 document.getElementById("whenreq").focus();
			 return false;
		 }
		 //when required
	 ...
	 if (document.getElementById("address").value == "")
		 ...
		 {
			 alert("Please enter Reason for blood");
	...
	<form method="post" action="ureginsert.php" name="form1" enctype="multipart/form-data">
		...
		<tr>
			<td style="padding:10px 0px 2px 200px;">
				<input type="submit" name="submit" value="Request Now" style="zoom:1.3;padding:4px 2px 2px 2px;background-color:red;border:1px solid red;"></input>
			</td>
		</tr>
	</form>
</table>
